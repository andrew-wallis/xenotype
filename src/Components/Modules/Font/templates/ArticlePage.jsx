...
function ArticlePage() {
  ...
  return (
    <div className="max-w-xl mx-auto">
      ...
      <ul className="flex gap-4 opacity-80 mb-8" style={{...small}}>
        <li>Emily Jones</li>
        <li>4 April 2024</li>
      </ul>
      ...
      <div className="pt-[50%] bg-dark-text/10 mb-2"></div>
      ...
      <blockquote className="px-6 my-6 italic opacity-80" style={{...quote}}>“In a world cluttered with information, minimalist fonts offer a breath of fresh air, allowing content to shine with clarity and elegance.”</blockquote>
      ...
      <blockquote className="px-6 my-6 italic opacity-80" style={{...quote}}>“Variable fonts usher in a new era of typographic versatility, empowering designers to craft dynamic compositions with unparalleled precision and fluidity.”</blockquote>
      ...
      <blockquote className="px-6 my-6 italic opacity-80" style={{...quote}}>“Experimental typography defies expectations, inviting audiences on a journey of visual exploration and discovery, where creativity knows no bounds.”</blockquote>
