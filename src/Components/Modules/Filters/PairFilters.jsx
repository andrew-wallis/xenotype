...
function PairFilters({showFilters, setShowFilters, filter, setFilter}) {
  ...
  return (
    <>
      <div className="rounded-full relative flex-1" ref={containerRef}>
         <div className={`absolute inset-0 z-10 flex justify-end pr-1 py-1 pl-[3.5rem] gap-4 duration-300 transition-all ease-out ${showFilters ? "opacity-100" : "opacity-0"}`}>
